...
class Node {
  ...
  constructor() {
    ...
    defineProperty(this, 'atime', new Date(0), validation.date);
    defineProperty(this, 'mtime', new Date(0), validation.date);
    defineProperty(this, 'ctime', new Date(0), validation.date);
  }
};
